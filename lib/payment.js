...
(function() {
  var addClass, cardFromNumber, cardFromType, cardTypeListeners, cards, defaultFormat, formatBackCardNumber, formatBackExpiry, formatCardNumber, formatExpiry, formatForwardExpiry, formatForwardSlash, hasClass, hasTextSelected, luhnCheck, normalizeEvent, on_, payment, preventDefault, reFormatCardNumber, removeClass, restrictCVC, restrictCardNumber, restrictExpiry, restrictNumeric, setCardType, toggleClass, trim,
  ...
  setCardType = function(e) {
    var callback, callbacks, card, cardType, target, value, _i, _j, _len, _len1;
    target = e.target;
    value = target.value;
  ...
  payment.onCardType = function(element, callback) {
    if (cardTypeListeners[element] == null) {
      cardTypeListeners[element] = [];
    }
    cardTypeListeners[element].push(callback);
  };

  payment.offCardType = function(element) {
